...
{
    public partial class frmDctSettingsLogin : Form
    {
        private SmdDbManager dbManager;
        public frmDctSettingsLogin()
        {
            InitializeComponent();
        ...
        private void txtOldPassword_TextChanged(object sender, EventArgs e)
        {
            ...
            else if (dbManager.ReadValue("SELECT * FROM ACCOUNT WHERE Login_Password = '" + txtOldPassword.Text + "'",3) == dbManager.ReadValue("SELECT * FROM ACCOUNT WHERE Roll_Id = '" + frmLogin.passingRoll + "'", 3))
            {
                lblOldpassword.ResetText();
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    string sqlcmd1 = "UPDATE ACCOUNT SET Login_Username = '" + txtUsername.Text + "' WHERE Roll_Id = 'R0006'";
                ...
                if(!string.IsNullOrEmpty(txtCofirmPassword.Text))
                {
                    string sqlcmd = "UPDATE ACCOUNT SET Login_Password = '" + txtCofirmPassword.Text + "' WHERE Roll_Id = 'R0006'";
