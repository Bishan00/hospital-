...
<section class="Xray-menu">
        <div class="container">
			...
			<?php
			   ...
			   $sql = "select * from in_patient_report where Admission_Number LIKE '%$search%'";
		     ...
		     ?>
                ...
                <div class="drug-menu">
                    ...
                    <br>
                     ...
                     <?php echo '<img src="data:image;base64,'.base64_encode($row['Report']).'" alt="Image" style="width: 1000px; height: 1000px;">' ;?> 
