...
<div class="topnav">
  ...
  <form action="outreport-search.php" method="POST">
                                    <input style="font-size:16px; color:black; background-color:#dae5ed;" type="search" name="search" placeholder="Enter Patient Id Number.." required>
                                    <input style="height:45px;" type="submit" name="submit" value="Search" class="btn btn-primary">
                                </form>
  </div>
</div>
