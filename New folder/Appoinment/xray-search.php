...
<section class="Xray-menu">
        <div class="container">
            <h2 class="text-left"><u>Xray Menu</u></h2>
			
			<?php
			   
			   $search = $_POST['search'];
			   
			   $sql = "select * from in_patient_xray where Admission_Number LIKE '%$search%'";
		     ...
		     ?>
                ...
                <div class="drug-menu">
                     ...
                     <div class="Admission_Number"> <b><br> Admission Number</br> </b>
                    <?php echo $Admission_Number; ?>
                    <div class="Ward_Number"> <b><br> Ward Number</br> </b>
                    <?php echo $Ward_Number; ?>
		       ...
		       <?php
				   ...
				   echo"<div class='error'>xray NOT FOUND</div>";
