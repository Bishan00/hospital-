...
?>
  <tr>
    ...
    <td><?php echo $data['Appointment_Number']; ?></td>
    <td><?php echo $data['Consultant_Name']; ?></td>
    
     <td><?php echo $data['Session_Date']; ?></td>
     <td><?php echo $data['Hospital_Fee']; ?></td>
