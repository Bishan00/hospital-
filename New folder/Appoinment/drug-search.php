...
<section class="drug-menu">
        <div class="container">
            <h2 class="text-left">Drug Menu</h2>
			...
			<?php
		     ...
		     ?>
                ...
                <div class="drug-menu">
                     ...
                     <div class="Number"> <b><br> Number</br> </b>
                    <?php echo $Number; ?>
                    <p class="Drug_name"> <b><br> Name</br> </b> <?php echo $Drug_Name; ?></p>
                    <p class="Drug_Price"><b><br> Price</br> </b><?php echo $Drug_Price; ?>
