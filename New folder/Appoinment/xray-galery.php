...
<div class="topnav">
  ...
  <form action="xray-search.php" method="POST">
                                    <input style="font-size:16px; color:black; background-color:#dae5ed;" type="search" name="search" placeholder="Enter Addmition.." required>
